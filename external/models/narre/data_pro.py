# CREDITS: https://github.com/chenchongthu/NARRE/blob/master/pro_data/data_pro.py
...
tf.compat.v1.flags.DEFINE_string("valid_data", f"../../../data/{args.dataset}/valid.tsv", " Data for validation")
tf.compat.v1.flags.DEFINE_string("test_data", f"../../../data/{args.dataset}/test.tsv", "Data for testing")
tf.compat.v1.flags.DEFINE_string("train_data", f"../../../data/{args.dataset}/train.tsv", "Data for training")
tf.compat.v1.flags.DEFINE_string("user_review", f"../../../data/{args.dataset}/user_review", "User's reviews")
tf.compat.v1.flags.DEFINE_string("item_review", f"../../../data/{args.dataset}/item_review", "Item's reviews")
tf.compat.v1.flags.DEFINE_string("user_review_id", f"../../../data/{args.dataset}/user_rid", "user_review_id")
tf.compat.v1.flags.DEFINE_string("item_review_id", f"../../../data/{args.dataset}/item_rid", "item_review_id")
tf.compat.v1.flags.DEFINE_string("stopwords", f"../../../data/stopwords", "stopwords")
...
if __name__ == '__main__':
    ...
    print('write begin')
    output = open(os.path.join(TPS_DIR, 'train'), 'wb')
    pickle.dump(batches_train, output)
    output = open(os.path.join(TPS_DIR, 'test'), 'wb')
    ...
    para['u_text'] = u_text
    para['i_text'] = i_text
    output = open(os.path.join(TPS_DIR, 'para'), 'wb')
