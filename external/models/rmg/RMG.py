...
class RMG(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._params_list = [
            ...
            ("_wcfm", "wcfm", "wcfm", 16, int, None),
            ("_wcfk", "wcfk", "wcfk", 3, int, None),
            ("_wa", "wa", "wa", 16, int, None),
            ("_scfm", "scfm", "scfm", 16, int, None),
            ("_scfk", "scfk", "scfk", 3, int, None),
            ("_sa", "sa", "sa", 16, int, None),
            ("_da", "da", "da", 16, int, None),
            ("_dau", "dau", "dau", 16, int, None),
            ("_factors", "factors", "f", 16, int, None),
            ("_uia", "uia", "uia", 16, int, None),
            ("_iua", "iua", "iua", 16, int, None),
            ("_ua", "ua", "ua", 16, int, None),
            ("_ia", "ia", "ia", 16, int, None),
